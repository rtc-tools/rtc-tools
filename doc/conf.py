...
htmlhelp_basename = "RTC-Toolsdoc"
...
latex_documents = [
    (master_doc, "RTC-Tools.tex", "RTC-Tools Documentation", "Deltares", "manual"),
]
...
man_pages = [(master_doc, "rtc-tools", "RTC-Tools Documentation", [author], 1)]
