...
from rtctools._internal.casadi_to_lp import deduplicate_constraint_names
...
class SinglePassGoalProgrammingMixin(_GoalProgrammingMixinBase):
    ...
    def __init__(self, **kwargs):
        ...
        self._gp_current_priority = None
        self._gp_n_priorities = 0
    ...
    def transcribe(self):
        ...
        if self.__additional_constraints:
            ...
            if self._collint_constraint_names is not None:
                ...
                self._reset_constraint_names(deduplicate_constraint_names(updated_constraint_names))
