model ExampleID
  // Elements
  //Deltares.ChannelFlow.Hydraulic.Branches.LinearisedSV Channel(width=30.0, n_QForcing=0, length=10000, n_level_nodes=12, H_b6.121_up=-5.0,  H_b_down=-5.0, H_nominal=6.121, H_nominal_down=5.0, Q_nominal=100.0, friction_coefficient=0.045)
  Deltares.ChannelFlow.Hydraulic.Branches.ID Channel(
  Ad=33333333.33333334,
  Delay_in_hour=2840.0)annotation(Placement(visible = true, transformation(origin = {0, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
