...
- **Type Annotations**: Use [PEP 484](https://peps.python.org/pep-0484/) type hints where appropriate to improve code clarity and enable static analysis. For union types in Python 3.9, use:
  ```python
  from typing import Optional
  x: Optional[str]
  ```
  In Python 3.10+, you can use the modern syntax:
  ```python
  x: str | None
  ```
...
pre-commit install
```
to set up the pre-commit hook. This will automatically check your code for formatting and linting issues before each commit.
...
To build the documentation, you will need matplotlib, sphinx and sphinx-rtd-theme:
