...
RTC-Tools a Series of LF Projects, LLC

The full charter is available at: [RTC-Tools Technical Charter (PDF)](https://lfx-cdn-prod.s3.us-east-1.amazonaws.com/project-artifacts/rtc-tools/rtc-tools_Charter.pdf)

Adopted 7-22-2025

---

This Charter sets forth the responsibilities and procedures for technical contribution to, and oversight of, the RTC-Tools open source project, which has been established as RTC-Tools a Series of LF Projects, LLC (the “Project”). LF Projects, LLC (“LF Projects”) is a Delaware series limited liability company. All contributors (including committers, maintainers, and other technical positions) and other participants in the Project (collectively, “Collaborators”) must comply with the terms of this Charter.

---

## 1. Mission and Scope of the Project

a. The mission of the Project is to provide a robust, flexible, and scalable framework that empowers organizations to efficiently manage and optimize their assets, contributing to sustainable water and energy solutions worldwide.
...
f. The TSC may elect a TSC Chair, who will preside over meetings of the TSC and will serve until their resignation or replacement by the TSC. The TSC Chair, or any other TSC member so designated by the TSC, will serve as the primary communication contact between the Project and LF Energy, a directed fund of The Linux Foundation. The Project has been initialized at Deltares. To acknowledge this, the TSC Chair is offered to Deltares first. If Deltares does not provide a candidate, other TSC members can be elected.
...
b. Except as described in Section 7.c., all contributions to the Project are subject to the following:
    ...
    i. All new inbound code contributions to the Project must be made using GNU Lesser General Public License v3.0GNU Library General Public License, Version 3.0, available at https://github.com/Deltares/rtc-tools/blob/master/COPYING (the “Project License”).
...
a. This charter may be amended by a two-thirds vote of the entire TSC and is subject to approval